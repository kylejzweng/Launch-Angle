...
SELECT last_name, first_name, exit_velocity_avg, launch_angle_avg FROM stats
ORDER BY exit_velocity_avg DESC, xwoba;
...
SELECT launch_angle_avg, AVG(xwoba) 
FROM stats
GROUP BY launch_angle_avg
ORDER BY AVG(xwoba) DESC;
...
CASE
    ...
    WHEN launch_angle_avg > 0.001 AND launch_angle_avg <= 5 THEN '0.001 - 5'
    WHEN launch_angle_avg > 5.001 AND launch_angle_avg <= 10 THEN '5.001 - 10'
    WHEN launch_angle_avg > 10.001 AND launch_angle_avg <= 15 THEN '10.001 - 15'
    WHEN launch_angle_avg > 15.001 AND launch_angle_avg <= 20 THEN '15.001 - 20'
    WHEN launch_angle_avg > 20.001 AND launch_angle_avg <= 25 THEN '20.001 - 25'
    WHEN launch_angle_avg > 25.001 AND launch_angle_avg<= 30 THEN '25.001 - 30'
    END as 'launch_angle'
FROM stats
GROUP BY 
	CASE 
    ...
    WHEN launch_angle_avg > 25.001 AND launch_angle_avg<= 30 THEN '25.001 - 30'
    END
ORDER BY launch_angle_avg;


SELECT *
FROM
stats
WHERE xwoba BETWEEN .300 AND .310 AND launch_angle_avg < 5;
...
SELECT last_name, first_name, year, launch_angle_avg, xwoba
FROM stats
WHERE launch_angle_avg >= 20
ORDER BY xwoba DESC;
...
SELECT last_name, first_name, year, exit_velocity_avg, launch_angle_avg
FROM stats
ORDER BY exit_velocity_avg DESC, xwoba;
...
SELECT last_name, first_name, year, exit_velocity_avg, launch_angle_avg, xwoba
FROM stats
WHERE last_name = 'Bote' OR last_name = 'Broxton'
ORDER BY exit_velocity_avg DESC;
...
SELECT last_name, first_name, year, exit_velocity_avg, launch_angle_avg, xwoba
FROM stats
WHERE exit_velocity_avg BETWEEN 92 AND 94 AND launch_angle_avg > 5
ORDER BY xwoba DESC;
...
SELECT AVG(exit_velocity_avg), year
FROM stats
GROUP BY year
ORDER BY year DESC;
...
SELECT AVG(launch_angle_avg), year
FROM stats
GROUP BY year
ORDER BY year DESC;
...
SELECT last_name, first_name, year, exit_velocity_avg, launch_angle_avg
FROM stats
WHERE launch_angle_avg < 11 AND exit_velocity_avg > 89
ORDER BY launch_angle_avg, exit_velocity_avg DESC;
...
SELECT last_name, first_name, year, exit_velocity_avg, launch_angle_avg
FROM stats
WHERE launch_angle_avg < 10 AND exit_velocity_avg > 85 AND year = 2020
ORDER BY exit_velocity_avg DESC;
...
SELECT last_name, first_name, year, exit_velocity_avg, launch_angle_avg
FROM stats
WHERE launch_angle_avg < 10 AND exit_velocity_avg > 85 AND year = 2022
ORDER BY exit_velocity_avg DESC;
